...
console.log("ABI is array?", Array.isArray(CONTRACT_ABI), CONTRACT_ABI);
    ...
    // --- Phase 4: wait + parse PackCreated ---
    ...
    // --- On-chain read-back check (optional but great) ---
    ...
    if (!String(onchainUri).endsWith(cid)) {
      console.warn("tokenURI does not end with CID; double-check contract/tokenURI()");
    }
